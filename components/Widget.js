...
const style = {
    ...
    newsItemLeft: `flex-1`,
    newsItemCategory: `text-[#8898a6] text-xs font-semibold`,
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.searchBar}>
                <BiSearch className={style.searchIcons} />
                <input className={style.inputBox} placeholder="Search Twitter" type="text" />
            </div>
